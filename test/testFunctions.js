...
module.exports = [
  ...
  (app, cb) => request(app).get('/query_raw_customErr/youCantCallThis').expect(403).expect('error: permission denied for function youcantcallthis').end(cb('check that we can\'t call a procedure without having appropriate privileges')),
